...
//echo 'alert("Could not insert event")';
//echo '</script>';
echo '<script type="text/javascript">alert("Could Not Insert! Overlapping Schedule!")</script>';

die("Could not insert event! Overlapping!");
        }
